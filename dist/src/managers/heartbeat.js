...
var HeartbeatManager = /** @class */ (function () {
    function HeartbeatManager(hi, s, ws) {
        this.beating = true;
        this.reciving = true;
        this.hi = hi;
        this.s = s;
    ...
    HeartbeatManager.prototype.update = function (hi, s) {
        this.s = s;
        this.hi = hi;
    };
    HeartbeatManager.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.beating) return [3 /*break*/, 2];
                        print_1.Print("Heartbeat!", true);
                        this.ws.send(JSON.stringify({
                            "op": 1,
                            "d": this.s
                        }));
                        return [4 /*yield*/, delay_1.delay(this.hi)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 0];
